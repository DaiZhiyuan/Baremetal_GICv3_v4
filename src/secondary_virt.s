//==================================================================
// GICv4.1 Example, code for secondary core (0.0.1.0)
//
...
wait:                       // We now have to wait for ChildrenAsleep to read 0
  ...
  // Set up SCR_EL3
  MOV      x0, #1
  ORR      x0, x0, #(1 << 10)    // Set RW bit (EL1 is AArch64, as this is the Secure world)
...
loop:
  WFI
  CBZ       x11, loop
  // Semihosting call(SYS_EXIT) to stop simulation
  MOV      w0, #0x18
  HLT      #0xf000
